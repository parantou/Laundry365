...
import com.acorn.boram.exception.NotDeleteException;
import com.acorn.boram.notice.dao.NoticeCommentDao;
import com.acorn.boram.notice.dao.NoticeDao;
...
public class NoticeServiceImpl implements NoticeService{
	...
	public void getDetail(HttpServletRequest request) {
		...
		*/
		...
		List<NoticeCommentDto> commentList=noticeCommentDao.getList(commentDto);

		//원글의 글번호를 이용해서 댓글 전체의 갯수를 얻어낸다.
		int totalRow=noticeCommentDao.getCount(num);
		//댓글 전체 페이지의 갯수
		int totalPageCount=(int)Math.ceil(totalRow/(double)PAGE_ROW_COUNT);
	...
	public void saveComment(HttpServletRequest request) {
		...
		//댓글의 시퀀스 번호 미리 얻어내기
		int seq=noticeCommentDao.getSequence();
	...
	public void deleteComment(HttpServletRequest request) {
		int num=Integer.parseInt(request.getParameter("num"));
		//삭제할 댓글 정보를 읽어와서 
		NoticeCommentDto dto=noticeCommentDao.getData(num);
		String id=(String)request.getSession().getAttribute("id");
